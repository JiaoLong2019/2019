...
public class OSSClientUtil {
    ...
    // accessKey
    private String accessKeyId = "LTAI4FtjFo9Zidy1JP9BDkak";
    private String accessKeySecret = "ZFQ82Zoi4oDgTDNAnJh7XMveHIPTyN";
    // 空间
    private String bucketName = "1905ban";
    // 文件存储目录
    private String filedir = "1905ban/";
